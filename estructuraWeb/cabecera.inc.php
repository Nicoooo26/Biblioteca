<header>
    <!-- Si el usuario tiene un rol de administrador -->
    ...
    <?php 
            ...
            //Si el usuario tiene un rol estándar.
            elseif(isset($_SESSION["rol"]) && $_SESSION["rol"] == "estandar"){
    ?>
        <button>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                <path fill="none" d="M0 0h24v24H0z"></path>
    ...
    <?php if(!isset($_SESSION["usuario"])){ ?>
        <img id="imagenCabecera" src="./img/icon.png"> 
        <p>Bibliotech</p>
    <?php }?>
</header>
